	...
	protected function output_about_info() {
		...
		<div class="hfe-admin-about-section hfe-admin-columns hfe-admin-about-us">
			...
			<div class="hfe-admin-column-60">
				...
				<?php 
				// translators: %s is replaced with the theme name.
					printf( esc_html__( 'This plugin is brought to you by the same team behind the popular WordPress theme %s and a series of Ultimate Addons plugins.', 'header-footer-elementor' ), esc_html( $white_labels['theme_name'] ) ); 
				?>
				</p>
