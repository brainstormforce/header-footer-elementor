...
class HFE_Settings_Page {
	...
	public function enqueue_admin_scripts() {
		...
		$strings = array(
			...
			'addon_error'                     => esc_html__( 'Could not install addon. Please download from wpforms.com and install manually.', 'header-footer-elementor' ),
			...
			'addon_search'                    => esc_html__( 'Searching Addons', 'header-footer-elementor' ),
			'ajax_url'                        => admin_url( 'admin-ajax.php' ),
			'cancel'                          => esc_html__( 'Cancel', 'header-footer-elementor' ),
			'close'                           => esc_html__( 'Close', 'header-footer-elementor' ),
			'entry_delete_confirm'            => esc_html__( 'Are you sure you want to delete this entry?', 'header-footer-elementor' ),
			'entry_delete_all_confirm'        => esc_html__( 'Are you sure you want to delete ALL entries?', 'header-footer-elementor' ),
			'entry_delete_n_confirm'          => esc_html__( 'Are you sure you want to delete {entry_count} entry(s)?', 'header-footer-elementor' ),
			'entry_empty_fields_hide'         => esc_html__( 'Hide Empty Fields', 'header-footer-elementor' ),
			'entry_empty_fields_show'         => esc_html__( 'Show Empty Fields', 'header-footer-elementor' ),
			'entry_field_columns'             => esc_html__( 'Entries Field Columns', 'header-footer-elementor' ),
			'entry_note_delete_confirm'       => esc_html__( 'Are you sure you want to delete this note?', 'header-footer-elementor' ),
			'entry_unstar'                    => esc_html__( 'Unstar entry', 'header-footer-elementor' ),
			'entry_star'                      => esc_html__( 'Star entry', 'header-footer-elementor' ),
			'entry_read'                      => esc_html__( 'Mark entry read', 'header-footer-elementor' ),
			'entry_unread'                    => esc_html__( 'Mark entry unread', 'header-footer-elementor' ),
			'form_delete_confirm'             => esc_html__( 'Are you sure you want to delete this form?', 'header-footer-elementor' ),
			'form_duplicate_confirm'          => esc_html__( 'Are you sure you want to duplicate this form?', 'header-footer-elementor' ),
			'heads_up'                        => esc_html__( 'Heads up!', 'header-footer-elementor' ),
			'importer_forms_required'         => esc_html__( 'Please select at least one form to import.', 'header-footer-elementor' ),
			'isPro'                           => wpforms()->pro,
			'nonce'                           => wp_create_nonce( 'hfe-admin-nonce' ),
			'almost_done'                     => esc_html__( 'Almost Done', 'header-footer-elementor' ),
			'oops'                            => esc_html__( 'Oops!', 'header-footer-elementor' ),
			'ok'                              => esc_html__( 'OK', 'header-footer-elementor' ),
			'plugin_install_activate_btn'     => esc_html__( 'Install and Activate', 'header-footer-elementor' ),
			'plugin_install_activate_confirm' => esc_html__( 'needs to be installed and activated to import its forms. Would you like us to install and activate it for you?', 'header-footer-elementor' ),
			'plugin_activate_btn'             => esc_html__( 'Activate', 'header-footer-elementor' ),
			'plugin_activate_confirm'         => esc_html__( 'needs to be activated to import its forms. Would you like us to activate it for you?', 'header-footer-elementor' ),
			'provider_delete_confirm'         => esc_html__( 'Are you sure you want to disconnect this account?', 'header-footer-elementor' ),
			'provider_delete_error'           => esc_html__( 'Could not disconnect this account.', 'header-footer-elementor' ),
			'provider_auth_error'             => esc_html__( 'Could not authenticate with the provider.', 'header-footer-elementor' ),
			'save_refresh'                    => esc_html__( 'Save and Refresh', 'header-footer-elementor' ),
			'server_error'                    => esc_html__( 'Unfortunately there was a server connection error.', 'header-footer-elementor' ),
			'testing'                         => esc_html__( 'Testing', 'header-footer-elementor' ),
			'upgrade_completed'               => esc_html__( 'Upgrade was successfully completed!', 'header-footer-elementor' ),
			'upload_image_title'              => esc_html__( 'Upload or Choose Your Image', 'header-footer-elementor' ),
			'upload_image_button'             => esc_html__( 'Use Image', 'header-footer-elementor' ),
			'upgrade_modal'                   => wpforms_get_upgrade_modal_text(),
			'choicesjs_loading'               => esc_html__( 'Loading...', 'header-footer-elementor' ),
			'choicesjs_no_results'            => esc_html__( 'No results found', 'header-footer-elementor' ),
			'choicesjs_no_choices'            => esc_html__( 'No choices to choose from', 'header-footer-elementor' ),
			'choicesjs_item_select'           => esc_html__( 'Press to select', 'header-footer-elementor' ),
			'debug'                           => wpforms_debug(),
			'edit_license'                    => esc_html__( 'To edit the License Key, please first click the Deactivate Key button. Please note that deactivating this key will remove access to updates, addons, and support.', 'header-footer-elementor' ),
		);
