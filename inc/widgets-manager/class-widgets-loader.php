...
class Widgets_Loader {
	...
	public function include_widgets_files() {
		...
		require_once HFE_DIR . '/inc/widgets-manager/widgets/class-product-ratings.php';
	...
	public function register_widgets() {
		...
		Plugin::instance()->widgets_manager->register_widget_type( new Widgets\Product_Ratings() );
	}
}
