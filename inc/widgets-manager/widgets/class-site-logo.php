...
class Site_Logo extends Widget_Base {
	...
	protected function render() {
		...
		if ( 'http://localhost/wordpress-5.3-copyrightwidget/wp-includes/images/media/default.png' === $site_image ) {
		...
		if ( 'http://localhost/wordpress-5.3-copyrightwidget/wp-includes/images/media/default.png' === $image_url ) {
