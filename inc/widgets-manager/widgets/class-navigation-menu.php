...
class Navigation_Menu extends Widget_Base
{
     ...
     */
    public static function is_elementor_updated(): bool
    {
     ...
     * @access public
     */
    public function handle_link_attrs(string $atts): string
    {
        $atts .= ' itemprop="url"';
        return $atts;
    }
     ...
     * @access public
     */
    public function handle_li_values(string $value): string
    {
        $value .= ' itemprop="name"';
        return $value;
    }
     ...
     * @access public
     */
    public function get_menu_close_icon(array $settings): array
    {
        $menu_icon = '';
        $close_icon = '';
        $icons = [];
     ...
     * @access protected
     */
    protected function render(): null|false
    {
        $menus = $this->get_available_menus();
