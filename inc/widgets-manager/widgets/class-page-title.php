...
class Page_Title extends Widget_Base {
	...
	protected function register_content_page_title_controls() {
		...
		$this->add_control(
			...
			[
				...
				// 'placeholder' => __('Enter your title', 'header-footer-elementor'),
				// 'default' => __('Add Your Heading Text Here', 'header-footer-elementor'),
	...
	/**
	 * Render Page Title output on the frontend.
	 *
