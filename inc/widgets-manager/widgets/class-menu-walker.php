...
class Menu_Walker extends \Walker_Nav_Menu
{
     ...
     * @access public
     */
    public function start_el(string &$output, object $item, int $depth = 0, array $args = [], int $id = 0): void
    {
     ...
     * @return (void | null)
     */
    public function display_element(object $element, object &$children_elements, int $max_depth, int $depth, array $args, string &$output): ?null
    {
