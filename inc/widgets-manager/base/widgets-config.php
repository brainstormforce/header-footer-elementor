	...
	public static function get_widget_list() {
		...
		self::$widget_list = [
			...
			'Basic_Posts'          => [
				...
				'title_url'   => '#',
				'default'     => true,
				'doc_url'     => 'https://ultimateelementor.com/docs/blog-post/?utm_source=plugin-editor&utm_medium=need-help-button&utm_campaign=uae-documentation',
				'is_pro'      => false,
				'is_new'      => true,
				'description' => __( 'Display posts in a fast, lightweight card layout with basic styling options.', 'header-footer-elementor' ),
				'demo_url'    => 'https://ultimateelementor.com/widgets/blog-posts/',
				'category'    => 'content',
			],
			'Breadcrumbs_Widget'   => [
