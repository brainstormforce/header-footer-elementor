...
( function() {
	if ( jQuery && jQuery.fn && jQuery.fn.select2 && jQuery.fn.select2.amd ) {
		...
		const e = [ 'znamuško', 'znamušce', 'znamuška', 'znamuškow' ],
			...
			const r = t.input.length - t.maximum; return 'Pšosym lašuj ' + r + ' ' + n( r, e );
		}, inputTooShort( t ) {
			const r = t.minimum - t.input.length; return 'Pšosym zapódaj nanejmjenjej ' + r + ' ' + n( r, e );
		}, loadingMore() {
