...
if ( ! class_exists( 'Astra_Notices' ) ) {
	...
	class Astra_Notices {
		...
		public function enqueue_scripts(): void {
			wp_register_style( 'astra-notices', self::get_url() . 'notices.css', [], self::$version );
			wp_register_script( 'astra-notices', self::get_url() . 'notices.js', [ 'jquery' ], self::$version, true );
			wp_localize_script(
				'astra-notices',
				'astraNotices',
				[
