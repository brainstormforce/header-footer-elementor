 ...
 *
 * @internal Please do not use this class outside of core HFE development. May be removed at any time.
 *
 * @since x.x.x
 */
class HFE_Plugin_Installer extends \Plugin_Upgrader {
	...
	public function install( $package, $args = array() ) {
		...
		if ( true === $result ) {
			do_action( 'hfe_plugin_installed', $package );
		}
