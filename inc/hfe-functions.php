 ...
 */
function hfe_header_enabled(): bool
{
 ...
 * @return bool True if header is enabled. False if header is not enabled.
 */
function hfe_footer_enabled(): bool
{
 ...
 */
function get_hfe_header_id(): string|bool
{
    $header_id = Header_Footer_Elementor::get_settings('type_header', '');
 ...
 * @return (String|bool) header id if it is set else returns false.
 */
function get_hfe_footer_id(): string|bool
{
    $footer_id = Header_Footer_Elementor::get_settings('type_footer', '');
 ...
 * @since  1.0.2
 */
function hfe_render_header(): void
{
 ...
 * @since  1.0.2
 */
function hfe_render_footer(): void
{
 ...
 */
function hfe_get_before_footer_id(): string|bool
{
 ...
 */
function hfe_is_before_footer_enabled(): bool
{
    $before_footer_id = Header_Footer_Elementor::get_settings('type_before_footer', '');
    $status = false;
 ...
 * @since  1.0.2
 */
function hfe_render_before_footer(): void
{
