      ...
      <div className="bg-white p-6 ml-6 rounded-lg">
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            {__("Loading before footer templates...", "header-footer-elementor")}
          </p>
        </div>
      </div>
    );
    ...
    return (
      <div className="bg-white p-6 ml-6 rounded-lg">
        ...
        <p className="text-sm text-text-tertiary text-center max-w-lg">
          {__(
            "You haven't created a before footer layout yet. Build a custom before footer to control how your site's top section looks and behaves across all pages.",
        ...
        <Button
          ...
          {__("Create Before Footer Layout", "header-footer-elementor")} 
        </Button>
        </div>
      </div>
    );
