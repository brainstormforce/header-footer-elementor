	...
	const footerItems = [
		{
			...
			onClick: () => window.open("https://your-site.com/edit-footer", "_blank"),
		},
		{
			id: "",
			name: "Before Footer",
			...
			onClick: () => window.open("https://your-site.com/edit-before-footer", "_blank"),
		},
		// Add more footer items as needed
	];

	const handleCreateFooter = (item) => {
							...
							<div className="relative h-60 w-full">
								...
								<div className="absolute inset-0 flex items-center justify-center rounded-lg overflow-hidden backdrop-blur-sm bg-black/40 transition-all duration-200 z-30">
									<Button
										...
										onClick={() => handleCreateFooter(item)}
									>
										{item.buttonText}
									</Button>
								</div>
