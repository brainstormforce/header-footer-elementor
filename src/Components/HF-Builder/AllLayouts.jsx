...
const AllLayouts = () => {
	...
	const [conditions, setConditions] = useState([
		{
			id: 1,
			conditionType: { id: 'include', name: __('Include', 'header-footer-elementor') },
			displayLocation: { id: 'entire-site', name: __('Entire Site', 'header-footer-elementor') }
		}
	]);
	...
	return (
		...
		<div className="bg-muted min-h-screen" style={{ padding: "40px" }}>
			<div className="flex items-start gap-10 justify-between mb-6" style={{ padding: "0 40px" }}>
			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-6" style={{ paddingLeft: "40px" }}>
				{layoutItems.map((item) => (
					<div className="border bg-background-primary border-gray-200 px-3 py-3 rounded-md overflow-hidden flex flex-col group relative">
					...
					<div className="flex justify-end gap-3">
						...
						<Button 
							onClick={() => {
								...
								if (selectedItem) {
									// You can add more logic here to save conditions
