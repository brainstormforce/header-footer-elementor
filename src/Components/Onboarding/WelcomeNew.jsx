...
const Welcome = ({ setCurrentStep }) => {
    return (
        <div className="bg-background-primary border-[0.5px] items-start justify-center border-subtle rounded-xl shadow-sm mb-6 p-8 flex flex-col max-w/max-w-xl">
            <div className="px-1">
                <div className="flex flex-col">
                    <h1 className="text-text-primary m-0 mb-2 hfe-65-width" style={{ fontSize: '30px', lineHeight: '1.3em' }}>
                    ...
                    <span className="text-md font-medium m-0 mb-2" style={{ lineHeight: '1.5em', color: '#111827' }}>
                        {__(
            ...
            <li className="none   " style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-start', gap: '0.5rem', color: '#111827' }}>
              <CheckIcon color="#111827" size={18} />
              {__('Disable unused widgets in one click, no bloat', 'header-footer-elementor')}
            </li>
            <li className="none " style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-start', gap: '0.5rem', color: '#111827' }}>
              <CheckIcon color="#111827" size={18} />
              {__('Design headers & footers exactly where you want them', 'header-footer-elementor')}
            </li>
            <li className="none " style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-start', gap: '0.5rem', color: '#111827' }}>
              <CheckIcon color="#111827" size={18} />
              {__('Reliable support from experts when you need it', 'header-footer-elementor')}
            </li>
          </ul>
