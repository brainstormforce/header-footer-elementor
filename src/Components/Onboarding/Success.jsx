...
const Success = () => {
    return (
        <div className="bg-background-primary border-[0.5px] border-subtle rounded-xl shadow-sm" style={{ height: '72vh' }}>
            <div className="bg-background-primary items-start justify-center p-8 flex flex-col">
                <div style={{
                    ...
                    <Container className="flex flex-col items-center justify-center">
                        <p className="text-4xl font-bold text-text-primary m-0 mt-2" style={{ fontSize: '40px' }}>
                            {__(
                                "Congratulations!",
                                "header-footer-elementor"
                            )}
                        </p>
                        <p className="text-md font-medium text-text-tertiary m-0 mt-2" style={{ fontSize: '16px' }}>
                            {__(
                                "You’ve unlocked a 20% discount on UAE Pro. We’ve sent a discount",
                                "header-footer-elementor"
                            )}
                        </p>
                        <p className="text-md font-medium text-text-tertiary m-0 mt-1" style={{ fontSize: '16px' }}>
                            {__(
