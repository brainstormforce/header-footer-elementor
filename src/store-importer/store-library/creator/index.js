...
import FlowNamePopup from '@Admin/store-importer/store-library/library/flow-name-popup';
...
const Creator = () => {
	...
	return (
		<div className="wcf-store-library-importer wcf-store-library--other">
			<div className="wcf-store-library-importer__header bg-white px-8 py-6 flex justify-between items-center border-b border-gray-200">
				<div className="wcf-store-importer__header-title text-2xl font-semibold text-gray-800">
					{ __( 'Start from Scratch', 'cartflows' ) }
				</div>
			</div>

			<div className="wcf-store-library-importer__list bg-white px-10 py-14">
				<FlowNamePopup
				...
				<div className="wcf-item wcf-item--start-from-blank flex gap-6 mx-auto max-w-4xl">
					...
					>
						<div className="wcf-item__thumbnail-wrap">
							<div className="wcf-item__thumbnail">
								<div className="wcf-store-importer__start-from-blank-icon bg-white p-6 rounded-full">
					...
					<div className="wcf_item__info flex flex-col gap-6 justify-center w-3/4">
						<h3 className="wcf_item__info--title text-2xl text-gray-800 font-semibold">
							{ __(
								'It seems that you are using the page builder other than Elementor, Beaver Builder, Divi & Gutenberg.',
								'cartflows'
							) }
						</h3>
