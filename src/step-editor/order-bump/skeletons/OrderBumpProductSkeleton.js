...
import './OrderBumpProductSkeleton.scss';

function OrderBumpProductSkeleton() {
	return (
		<div className="wcf-order-bump-product-tab p-6 is-placeholder">
			<div
				role="status"
			...
			<div className="flex gap-4 mt-6">
				<span className="w-20 h-4 bg-gray-200 rounded-md"></span>
				<span className="w-20 h-4 bg-gray-200 rounded-md"></span>
				<span className="w-20 h-4 bg-gray-200 rounded-md"></span>
				<span className="w-20 h-4 bg-gray-200 rounded-md"></span>
			</div>
...
export default OrderBumpProductSkeleton;
