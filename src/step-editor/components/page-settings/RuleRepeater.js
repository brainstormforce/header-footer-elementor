...
function RuleRepeater( { rules, group_id, g_index, groups_length } ) {
		...
		<>
			{ rules.map( ( rule, r_index ) => {
				...
				return (
					<>
						{ 0 !== r_index && (
							<div className="wcf-checkout-rules--group_rules__condition-label">
						...
						<div
							className="wcf-checkout-rules--group_rules flex gap-3 items-center"
						...
						>
							...
							<div className="wcf-checkout-rules--rule_fields grid grid-cols-3 gap-3 items-center w-full">
								<SelectField
							...
							<div className="wcf-checkout-rules--rule_actions">
