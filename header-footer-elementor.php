...
function hfe_enqueue_font_awesome() {
	if ( defined( 'ELEMENTOR_VERSION' ) ) {
		if ( ! wp_style_is( 'elementor-icons-fa-solid', 'enqueued' ) ) {
			wp_enqueue_style( 'hfe-fa-solid', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/solid.min.css', [], '5.15.4' );
		}
		if ( ! wp_style_is( 'elementor-icons-fa-regular', 'enqueued' ) ) {
			wp_enqueue_style( 'hfe-fa-regular', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/regular.min.css', [], '5.15.4' );
		}
		if ( ! wp_style_is( 'elementor-icons-fa-brands', 'enqueued' ) ) {
			wp_enqueue_style( 'hfe-fa-brands', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/brands.min.css', [], '5.15.4' );
		}
	} else {
		wp_enqueue_style( 'hfe-fa-all', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css', [], '5.15.4' );
	}
}
