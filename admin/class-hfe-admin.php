...
class HFE_Admin
{
     ...
     */
    private static HFE_Admin $_instance = null;
     ...
     */
    public static function instance(): HFE_Admin
    {
     ...
     * @access public
     */
    public static function hfe_admin_enqueue_scripts(string $hook): void
    {
     ...
     * @since 1.4.0
     */
    public function register_hfe_epro_script(): void
    {
        $ids_array = [
            [
     ...
     */
    public function column_headings(array $columns): array
    {
        unset($columns['date']);
     ...
     */
    public function column_content(array $column, int $post_id): void
    {
     ...
     */
    public function column_display_location_rules(array $locations): void
    {
        $location_label = [];
     ...
     */
    public function header_footer_posttype(): void
    {
     ...
     */
    public function ehf_register_metabox(): void
    {
        add_meta_box(
            'ehf-meta-box',
     ...
     */
    public function efh_metabox_render(array $post): void
    {
     ...
     * @since  1.0.0
     */
    public function display_rules_tab(): void
    {
     ...
     * @return Void
     */
    public function ehf_save_meta(POST $post_id): void
    {
     ...
     * @since 1.0.0
     */
    public function location_notice(): void
    {
        global $pagenow;
        global $post;
     ...
     */
    public function template_location(string $template_type): string
    {
        return ucfirst(str_replace('type_', '', $template_type));
    }
     ...
     */
    public function load_canvas_template(string $single_template): string
    {
        global $post;
     ...
     */
    public function set_shortcode_columns(array $columns): array
    {
     ...
     * @param int   $post_id post id.
     */
    public function render_shortcode_column(array $column, int $post_id): void
    {
        switch ($column) {
            case 'shortcode':
                ob_start();
